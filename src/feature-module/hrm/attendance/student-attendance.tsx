...
const StudentAttendance = () => {
  ...
  const [allStudentsList, setAllStudentsList] = useState<any[]>([]); // Original list preserve for filter
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (data.success) {
        setAttendanceData((prev) => prev.map((student) => ({ ...student, attendance: "Absent", notes: "" })))
